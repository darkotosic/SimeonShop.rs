  ...
  return (
    <form className="space-y-4 border border-slate-200 bg-white p-5">
      ...
      <label className="block text-sm text-slate-700">
        Pretraga
        <input name="q" defaultValue={searchParams.q} className="mt-2 w-full border border-slate-300 px-3 py-2" />
      </label>
      <label className="block text-sm text-slate-700">
        Kategorija
      ...
      <div className="grid grid-cols-2 gap-3">
        <label className="block text-sm text-slate-700">
          Min RSD
          <input name="min_price_rsd" inputMode="decimal" defaultValue={searchParams.min_price_rsd} className="mt-2 w-full border border-slate-300 px-3 py-2" />
        </label>
        <label className="block text-sm text-slate-700">
          Max RSD
          <input name="max_price_rsd" inputMode="decimal" defaultValue={searchParams.max_price_rsd} className="mt-2 w-full border border-slate-300 px-3 py-2" />
        </label>
      </div>
      <label className="block text-sm text-slate-700">
        Sortiranje
      ...
      <div className="space-y-2">
        ...
        <Link href="/products" className="block w-full border border-slate-300 px-4 py-3 text-center text-sm font-semibold text-primary">Resetuj filtere</Link>
      </div>
    </form>
  );
}
